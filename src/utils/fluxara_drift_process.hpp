...
#ifndef HEADER_FLUXARA_DRIFT_PROCESS_HPP
#define HEADER_FLUXARA_DRIFT_PROCESS_HPP
...
namespace FLUXARA_DRIFTProcess
{
    // ========================================================================
    ...
    // ------------------------------------------------------------------------
    /** Reset when fluxara_drift is started (for android mostly). */
