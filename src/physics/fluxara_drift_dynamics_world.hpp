...
#ifndef HEADER_FLUXARA_DRIFT_DYNAMICS_WORLD_HPP
#define HEADER_FLUXARA_DRIFT_DYNAMICS_WORLD_HPP
 ...
 */
class FLUXARA_DRIFTDynamicsWorld : public btDiscreteDynamicsWorld
{
public:
    /** The standard constructor which just created a btDiscreteDynamicsWorld. */
    FLUXARA_DRIFTDynamicsWorld(btDispatcher*             dispatcher,
