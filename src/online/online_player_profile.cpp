...
namespace Online
{
    ...
    irr::core::stringw PrivateRequest::SignInRequest::getLocalizedInfo() const
    {
        ...
        //       doesn't prevent previous FLUXARA_DRIFT versions from interpreting the server message.
    ...
    void OnlinePlayerProfile::requestSignOut()
    {
        ...
        public:
             ...
             *  quit-fluxara_drift request). This allows the final logout request at
             *  the end of FLUXARA_DRIFT to be handled, even if a quit request gets
