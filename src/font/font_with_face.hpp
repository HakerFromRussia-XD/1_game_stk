 ...
 *  bitmap and render them in FLUXARA_DRIFT. To make FLUXARA_DRIFT draw characters with different
...
{
public:
    /** A class for \ref FLUXARA_DRIFTTextBillboard to get font info to render billboard
     *  text. */
