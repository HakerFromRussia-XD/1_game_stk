...
#ifndef FLUXARA_DRIFT_TEXT_BILLBOARD_HPP
#define FLUXARA_DRIFT_TEXT_BILLBOARD_HPP
...
class FLUXARA_DRIFTTextBillboard : public ISceneNode, public NoCopy,
...
private:
    struct FLUXARA_DRIFTTextBillboardChar
    {
        ...
        // ------------------------------------------------------------------------
        FLUXARA_DRIFTTextBillboardChar(video::ITexture* texture,
    ...
    std::vector<FLUXARA_DRIFTTextBillboardChar>* m_chars = NULL;
...
public:
    // ------------------------------------------------------------------------
    FLUXARA_DRIFTTextBillboard(const video::SColor& color_top,
