...
#ifndef HEADER_FLUXARA_DRIFT_PARTICLE_HPP
#define HEADER_FLUXARA_DRIFT_PARTICLE_HPP
...
class FLUXARA_DRIFTParticle : public scene::CParticleSystemSceneNode
{
private:
    // ------------------------------------------------------------------------
...
public:
    // ------------------------------------------------------------------------
    FLUXARA_DRIFTParticle(bool randomize_initial_y = false,
