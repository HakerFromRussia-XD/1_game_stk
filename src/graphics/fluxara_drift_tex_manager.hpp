...
#ifndef HEADER_FLUXARA_DRIFT_TEX_MANAGER_HPP
#define HEADER_FLUXARA_DRIFT_TEX_MANAGER_HPP
...
class FLUXARA_DRIFTTexture;
namespace irr
{
    namespace video { class SColor; }
}

class FLUXARA_DRIFTTexManager : public Singleton<FLUXARA_DRIFTTexManager>, NoCopy
{
private:
