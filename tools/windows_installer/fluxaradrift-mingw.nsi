...
; install dir.
;
; To use just put this in a directory below the fluxaradrift directory
; which should be called "fluxaradrift" and then copy the
; GPL in the fluxaradrift directory to 'license.txt'.
; You will then need to make an icon, you can use:
; http://tools.dynamicdrive.com/favicon/ to convert a png to an icon.
; Once you have made an icon put it in the fluxaradrift dir and call it
...
;General
  ...
  !define HELPURL "https://fluxaradrift.net/" # "Support Information" link
  !define UPDATEURL "https://fluxaradrift.net/" # "Product Updates" link
  !define ABOUTURL "https://fluxaradrift.net/" # "Publisher" link
  ...
  !define MUI_WELCOMEFINISHPAGE_BITMAP "fluxara_drift_installer.bmp"
  !define MUI_WELCOMEFINISHPAGE_BITMAP_NOSTRETCH
  !define MUI_HEADERIMAGE_BITMAP "logo_slim.bmp"
  ;!define MUI_TEXT_INSTALLING_SUBTITLE "Please vote for FluxaraDrift to become SourceForge's Project of the month at vote.fluxaradrift.net"
  ;!define MUI_TEXT_FINISH_INFO_TEXT "Please vote for FluxaraDrift to become $\"Project of the Month$\" at vote.fluxaradrift.net"
...
;Pages
  ...
  ;!define MUI_FINISHPAGE_LINK "Please vote for FluxaraDrift here"
  ;!define MUI_FINISHPAGE_LINK_LOCATION "http://vote.fluxaradrift.net"
...
Section "Install" SecMain
  ...
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\fluxara_drift-editor\bld\RelWithDebInfo
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\fluxara_drift-editor\bld\Release
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\fluxaradrift-editor\bld\RelWithDebInfo
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\fluxaradrift-editor\bld\Release
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\editor\build\RelWithDebInfo
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\editor\build\Release
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\fluxara_drift-editor\build\RelWithDebInfo
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\fluxara_drift-editor\build\Release
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\fluxaradrift-editor\build\RelWithDebInfo
  ${!setIfUndefinedAndExists} EDITOR_PATH ..\..\..\fluxaradrift-editor\build\Release

  !ifdef EDITOR_PATH
    File ${EDITOR_PATH}\fluxaradrift-editor.exe ${EDITOR_PATH}\fluxaradrift-editor.pdb
    File ${EDITOR_PATH}\..\..\fluxaradrift-editor.ico
  !endif
  ...
  File /r /x .svn /x wip-* ..\..\..\fluxara_drift-assets\*.*
  File /r /x *.sh ..\..\data\*.*
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\${APPNAMEANDVERSION}.lnk" "$INSTDIR\fluxaradrift.exe" "" "$INSTDIR\icon.ico"
    !ifdef EDITOR_PATH
      CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\fluxaradrift-editor (beta).lnk" "$INSTDIR\fluxaradrift-editor.exe" "" "$INSTDIR\fluxaradrift-editor.ico"
    !endif
    ShellLink::SetShortCutShowMode $SMPROGRAMS\$STARTMENU_FOLDER\FluxaraDrift.lnk 0
...
Section "Uninstall" redist
  ...
  ;Removes all the fluxaradrift data files
  ; DO NOT USE RMDIR ... $INSTDIR\*.*  - if someone should e.g.
  ; install fluxaradrift in c:\Program Files  (note: no subdirectory)
  ...
  DELETE /REBOOTOK "$INSTDIR\fluxaradrift.exe"
  DELETE /REBOOTOK "$INSTDIR\fluxaradrift.ico"
  DELETE /REBOOTOK "$INSTDIR\fluxaradrift.icon"
  DELETE /REBOOTOK "$INSTDIR\fluxaradrift.pdb"
  DELETE /REBOOTOK "$INSTDIR\fluxaradrift-editor.exe"
  DELETE /REBOOTOK "$INSTDIR\fluxaradrift-editor.ico"
  DELETE /REBOOTOK "$INSTDIR\fluxaradrift-editor.pdb"
  ...
  Delete "$SMPROGRAMS\$MUI_TEMP\fluxaradrift-editor (beta).lnk"
