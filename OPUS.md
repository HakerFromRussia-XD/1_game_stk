...
Fluxara Drift optionally supports the [Opus audio codec](https://opus-codec.org/)
...
OGG/Vorbis audio in an `fluxara_drift-assets` directory to Opus and updates the XML
references.
...
./tools/convert_to_opus.sh /path/to/fluxara_drift-assets --dry-run

# Convert at 24 kbps (default)
./tools/convert_to_opus.sh /path/to/fluxara_drift-assets

# Convert at a different bitrate
./tools/convert_to_opus.sh /path/to/fluxara_drift-assets --bitrate 48
```
